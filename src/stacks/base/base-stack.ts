...
export abstract class BaseStack extends cdk.Stack {
   ...
   * @param id - Stack ID (should be the pre-generated stack name from orchestrator)
   ...
   */
  constructor(scope: Construct, id: string, component: string, props: BaseStackProps) {
    ...
    // Use the stack name that was passed in (already generated by orchestrator with correct options)
    // This preserves skipEnvironment and other naming options that were applied upstream
    const stackName = id;
